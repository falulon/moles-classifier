var cropper; 
var squareSize = window.screen.width > window.screen.height ? 200 : 400   // cropper elenemnt size for portrait / landscape screens
...
async function cropSave() { 
    var params = {type: 'base64', size: 'viewport', format: 'jpeg', quality: 1, circle: false }
